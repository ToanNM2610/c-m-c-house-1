        ...
        >
          {safePosts.map((post) => (
            ...
            >
              <Link 
                href={`/posts/${post.id}`} 
                className="group flex flex-col bg-[#24140C] rounded-3xl border border-[#C5A880]/25 overflow-hidden hover:border-[#C5A880]/75 transition-all duration-300 hover:-translate-y-1 shadow-xl h-full"
              >
