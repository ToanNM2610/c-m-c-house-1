    ...
    <div className="w-full text-[#FDFBF7] relative z-10 bg-[#0C0D0B]">
      ...
      <section className="relative w-full min-h-screen flex flex-col items-center justify-center px-6 pt-20">
        ...
        <div className="flex flex-col items-center text-center relative z-10">
          {/* Hero text: visible immediately on load — no viewport trigger */}
          ...
          <h1 className="font-serif text-5xl md:text-8xl font-semibold uppercase mb-6 text-[#F5EFEB] drop-shadow-lg">
            CẨM CÙ HOUSE
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-6">
            <Link
              href="/space"
              className="inline-flex items-center justify-center px-10 py-4 bg-[#C88A4B] text-[#0a0705] font-sans font-medium rounded-full shadow-lg hover:shadow-[#C88A4B]/30 hover:-translate-y-1 transition-all duration-300"
            >
              Khám Phá Không Gian
            </Link>
            <Link
      ...
      <section className="relative py-32 px-6 sm:px-12 lg:px-24 bg-[#0a0705]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-20 items-center">
          <CinematicReveal className="md:col-span-5 relative w-full aspect-[4/5] rounded-2xl overflow-hidden border border-[#C88A4B]/15">
            <Image
          ...
          <CinematicReveal className="md:col-span-7 flex flex-col justify-center" delay={0.15}>
      ...
      <section className="relative py-32 px-6 sm:px-12 lg:px-24 bg-[#0a0705]/95 border-t border-[#FDFBF7]/5">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: "Bờ Suối Tự Nhiên", desc: "Bàn gỗ sát mép nước mát rượi, tiếng suối chảy róc rách", img: "/uploads/gallery/1788250253551-943009233.jpg" },
              { title: "Hiên Gỗ & Hoa Cẩm Cù", desc: "Không gian mở thoáng đãng ngập sắc hoa và ánh nắng dịu", img: "/uploads/gallery/1788250253554-875120458.jpg" },
              { title: "Cà Phê Mộc Rang Củi", desc: "Hương vị Robusta Tây Nguyên nguyên bản, ấm nồng đặc trưng", img: "/uploads/gallery/1788250253557-29323827.jpg" },
            ].map((exp, idx) => (
              <CinematicReveal key={idx} delay={idx * 0.1}>
                <div className="group flex flex-col gap-6">
                  ...
                  <div>
                    ...
                    <p className="font-sans font-light text-[#FDFBF7]/70 leading-relaxed">{exp.desc}</p>
                  </div>
                </div>
              </CinematicReveal>
            ))}
      ...
      {/* =========================================
          SECTION 4: THỨC UỐNG & MÓN ĂN TIÊU BIỂU
      ========================================= */}
      <section className="relative py-32 px-6 sm:px-12 lg:px-24 bg-[#0a0705] border-t border-[#FDFBF7]/5">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-left mb-16">
            {[
              { name: "Cà phê muối", price: "28.000đ", desc: "Mặn mà, béo ngậy, Tây Nguyên" },
              { name: "Trà đào cam sả", price: "27.000đ", desc: "Thanh mát, sảng khoái tự nhiên" },
              { name: "Bánh mì ốp la xúc xích", price: "25.000đ", desc: "Giòn rụm, no bụng buổi sáng" },
              { name: "Bò kho bánh mì", price: "45.000đ", desc: "Đậm vị, thơm lừng ấm bụng" },
            ].map((item, idx) => (
              <CinematicReveal key={idx} delay={idx * 0.1}>
                <div className="bg-[#1A1D17]/50 border border-[#FDFBF7]/10 rounded-2xl p-6 hover:-translate-y-1.5 hover:shadow-[0_8px_30px_rgba(200,138,75,0.12)] transition-all duration-300">
                  <h3 className="font-serif text-xl font-medium text-[#F5EFEB] mb-1">{item.name}</h3>
                  <p className="font-sans text-sm font-light text-[#FDFBF7]/50 mb-4">{item.desc}</p>
                  <div className="font-sans font-medium text-[#C88A4B] tracking-wide">{item.price}</div>
                </div>
              </CinematicReveal>
            ))}
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 divide-x divide-[#FDFBF7]/10">
            {[
              ...
              <CinematicReveal key={idx} delay={idx * 0.1}>
                <div className="px-4 text-center flex items-center justify-center h-full">
      ...
      <section className="relative py-32 px-6 sm:px-12 bg-[#1A1D17]/40">
        <CinematicReveal className="max-w-4xl mx-auto text-center">
      ...
      <section className="relative py-32 px-6 sm:px-12 text-center bg-[#0a0705]">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <CinematicReveal delay={0.3}>
            <Link
              href="/contact"
              className="inline-flex items-center justify-center px-10 py-4 bg-[#F5EFEB] text-[#0a0705] font-sans font-medium rounded-full hover:bg-[#C88A4B] hover:text-[#0a0705] transition-colors duration-300 shadow-md"
            >
